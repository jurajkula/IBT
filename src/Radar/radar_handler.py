        ...
        while True:
            while self.lostSync == 0:
                ...
                if dataLength > 0:
                    ...
                    if self.state == 'save':
                        savePointCloudToJSON(self.start, self.rxHeader, self.rxData)
                ...
                for n in range(tNumC):
                    ...
                    print(S[:, n])
                    detectionObjects.append(rObject)
