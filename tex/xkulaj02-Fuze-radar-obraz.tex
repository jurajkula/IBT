...
\projectinfo{
  ...
  title.cs={Spracovanie radarového signálu a fúzia s obrazom},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Radar Signal Processing and Fusion with Image}, % název práce v angličtině / thesis title in english
  %title.length={14.5cm}, % nastavení délky bloku s titulkem pro úpravu zalomení řádku (lze definovat zde nebo níže) / setting the length of a block with a thesis title for adjusting a line break (can be defined here or below)
  %Autor / Author
  author.name={Juraj},   % jméno autora / author name
  author.surname={Kula},   % příjmení autora / author surname 
  ...
  declaration={Prehlasujem, že som túto bakalársku prácu vypracoval samostatne pod vedením pána X...
Ďalšie informácie mi poskytli...
